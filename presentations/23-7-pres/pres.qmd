...
-   Content authored with markdown (such as a - creating bullets)
...
## Background images {background-image="quarto.svg" background-size="100px" background-repeat="repeat-x"}
...
::: fragment
``` r
## Background images {background-image="quarto.svg" background-size="100px"
